                    ...
                    <form class="d-flex my-2 my-lg-0 " action="searchProduct.php" method='GET'>
                        ...
                        <div class="dropdown ms-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#" id="orders">My Orders</a></li>
   ...
   ?>
            ...
            <div class=" col-md-2 p-1 " id="">
                <div class=" addImg mb-3  me-2 ">
                 <a href="/Ecormmerce/users/signup.php"> <img src="./images/CAROUSEL ADVERT.png" class="w-100 " class="mb-5" alt="..."></a> 
                </div>
            ...
            <div class="row mt-3 d-flex justify-content-center  ">
                ...
                <div class="col-md-1 mt-2 gap-5 ms-3 " id="">
                 ...
                 <div class="col-md-1 mt-2 gap-5 ms-5 " id="">
                    ...
                    <div class=" ">
                        <img src="./images/banner-furniture.jpeg" class="w-100 " class="mb-5 " id='banner-img' alt="...">
                    </div>
                 ...
                 <div class="col-md-1 mt-2  gap-5 ms-5 " id="">
                    ...
                    <div class=" ">
                        <img src="./images/banner-drinks.png" class="w-100 " class="mb-5 " id='banner-img' alt="...">
                    </div>
                  ...
                  <div class="col-md-1 mt-2 gap-5  ms-5 " id="">
                    <div class=" ">
                        <img src="./images/banner-lingeries.jpg" class="w-100 " class="mb-5 " id='banner-img' alt="...">
                    </div>
                 ...
                 <div class="col-md-1 mt-2 gap-5 ms-5 " id="">
                    <div class=" ">
                        <img src="./images/banner-crocs.jpeg" class="w-100 " class="mb-5 " id='banner-img' alt="...">
                    </div>
